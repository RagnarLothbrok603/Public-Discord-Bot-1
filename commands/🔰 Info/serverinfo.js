...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player) => {
    ...
    try {
      ...
      embed.addField("**<a:arrow:933154071869796384> Rules Channel:**", `${message.guild.rulesChannel ? `<#${message.guild.rulesChannelId}>`: "<a:nope:989296885820964874> \`No Channel\`"}`, true)
      embed.addField("**<a:arrow:933154071869796384> Public Updates Channel:**", `${message.guild.publicUpdatesChannel ? `<#${message.guild.publicUpdatesChannelId}>`: "<a:nope:989296885820964874> \`No Channel\`"}`, true)
      embed.addField("**<a:arrow:933154071869796384> AFK Channel:**", `${message.guild.afkChannel ? `<#${message.guild.afkChannelId}>`: "<a:nope:989296885820964874> \`No Channel\`"}`, true)

      embed.addField("**<a:arrow:933154071869796384> NSFW Level:**", `\`${message.guild.nsfwLevel}\``, true)
      embed.addField("**<a:arrow:933154071869796384> Verifcation Level:**", `\`${message.guild.verificationLevel}\``, true)
      embed.addField("**<a:arrow:933154071869796384> Explicit Content Filter:**", `\`${message.guild.explicitContentFilter}\``, true)
      ...
      embed.addField(client.la[ls].cmds.info.serverinfo.field12, "<a:nitrologgo:989308139037945899> \`" + message.guild.premiumSubscriptionCount + "\`", true)

      embed.addField(client.la[ls].cmds.info.serverinfo.field13, `<a:nitro:989308332860903434> \`${boostlevel}\``, true)
      embed.addField(client.la[ls].cmds.info.serverinfo.field14, "👾 \`" + maxbitrate + " kbps\`", true)
      if(boosts >= 14){
          embed.addField(`**<a:arrow:933154071869796384> Vanity:**`, `${message.guild.vanityURLCode ? `https://discord.gg/${message.guild.vanityURLCode}` : "<a:nope:989296885820964874> No Vanity-Invite"}`)
      }
      ...
      if(message.guild.banner) {
        ...
        .setTitle(`**<a:arrow:933154071869796384> SERVER BANNER:**`)
        ...
        let embed2 = new Discord.MessageEmbed()
        .setTitle(`**<a:arrow:933154071869796384> SERVER DISCOVERY SPLASH:**`)
