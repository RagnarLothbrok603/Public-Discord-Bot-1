  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    let ls = client.settings.get(message.guild.id, "language")
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField('<a:arrow:933154071869796384> **Name**', "```"+json.name+"```", true)
        .addField("<a:arrow:933154071869796384> **Hex**",  "```"+json.hex+"```", true)
        .addField("<a:arrow:933154071869796384> **RGB**",  "```"+json.rgb+"```", true)
        .addField(`<a:arrow:933154071869796384> **${client.la[ls].cmds.info.color.brightershade}**`,  "```"+json.brightened +"```", true)
