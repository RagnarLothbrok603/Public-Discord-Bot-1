...
module.exports = {
	...
	run: async (client, message, args, cmduser, text, prefix) => {
		...
		try {	
			...
			let button_support_dc = new MessageButton().setStyle('LINK').setLabel(client.la[ls].cmds.info.developer.buttons.dc).setURL("https://discord.gg/ymnQXzyBw8")
			let button_invite = new MessageButton().setStyle('LINK').setLabel(client.la[ls].cmds.info.developer.buttons.botlist).setURL(`https://comingsoon.com`)
			...
			message.reply({embeds: [new MessageEmbed()
				...
				.setURL("https://dark-web.ro")
				.addField("🆕 NEW GITHUB", `> There is now an **open Source** Version of this Bot on [\`0x5EC06745#4435\`'s Github](https://github.com/RagnarLothbrok603)\n> [Link](https://github.com/RagnarLothbrok603) )`)
