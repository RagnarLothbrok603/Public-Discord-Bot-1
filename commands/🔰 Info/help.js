  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      if (args[0]) {
        ...
        let button_tutorial = new MessageButton().setStyle('LINK').setEmoji("840260133686870036").setLabel("Dashboard").setURL("https://comingsoon.com")
        let menuOptions = [
          {
            label: "Overview",
            value: "Overview",
        ...
        let OverviewEmbed = new MessageEmbed()
          ...
          .addField(":muscle: **__My Features__**",
            `>>> **58+ Systems**, like: <a:ragnartwitter:985171547926966273> **Twitter** & <a:ragnaryoutube:985172090472763432> **Youtube-Auto-Poster** 
**Application**, <:ragnarapplication:985187769267667056> Ticket, **Welcome-Images** and Reaction Role, ... Systems
:notes: An advanced <a:ragnarspotify:985172532665655326> **Music System** with **Audio Filtering**
<:ragnararcade:985188905081012275> Many **Minigames** and <:ragnarhahaha:890869363949858826> **Fun** Commands (150+)
<:ragnaradministrator:985180342220644452> **Administration** and **Auto-Moderation** and way much more!`)
          .addField("<:ragnarask:985192096619184219> **__How do you use me?__**",
...
but you can also do \`${prefix}setup-SYSTEM\` e.g. \`${prefix}setup-welcome\``)
          .addField("<a:ragnarstats:985171917956841482> **__STATS:__**",
            `>>> <a:ragnarpython:985173504985034812> **${client.commands.map(a => a).length} Commands**
                 <a:ragnardiscord:985174233841799169> on **${client.guilds.cache.size} Guilds**
                 <a:ragnaruptime:985178135890894898> **${duration(client.uptime).map(i => `\`${i}\``).join("︲")} Uptime**
                 <:ragnaronline:985179205337759834> **\`${Math.floor(client.ws.ping)}ms\` Ping**
                 <a:ragnardeveloper:985179566505070634>  Made by [**0x5EC06745#4435**](https://ionutsdm.com)`)
          .addField("<a:ragnarfaq:985190081440677918> How to get help?", `>>> **\` 1. Way \`** *Use the Buttons, to swap the Pages*\n**\` 2. Way \`** *Use the Menu to select all Help Pages, you want to display*\n\ `)
      ...
      function allotherembeds_eachcategory(filterdisabled = false) {
        ...
        var embed1 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "💸 Economy").size}\`] 💸 Economy Commands 💸 | ${settings.ECONOMY ? "<a:yes:833101995723194437> ENABLED" : "<a:nope:989296885820964874> DISABLED"}`)
        ...
        var embed2 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🏫 School Commands").size}\`] 🏫 School Commands 🏫 | ${settings.SCHOOL ? "<a:yes:833101995723194437> ENABLED" : "<a:nope:989296885820964874> DISABLED"}`)
        ...
        var embed3 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🎶 Music").size}\`] 🎶 Music Commands 🎶 | ${settings.MUSIC ? "<a:yes:833101995723194437> ENABLED" : "<a:nope:989296885820964874> DISABLED"}`)
        ...
        var embed4 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "👀 Filter").size}\`] 👀 Filter Commands 👀 | ${settings.FILTER ? "<a:yes:833101995723194437> ENABLED" : "<a:nope:989296885820964874> DISABLED"}`)
        ...
        var embed5 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "⚜️ Custom Queue(s)").first().extracustomdesc.length}\`] ⚜️ Custom Queue(s) Commands ⚜️ | ${settings.CUSTOMQUEUE ? "<a:yes:833101995723194437> ENABLED" : "<a:nope:989296885820964874> DISABLED"}`)
        ...
        var embed10 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "⌨️ Programming").size}\`] ⌨️ Programming Commands ⌨️ | ${settings.PROGRAMMING ? "<a:yes:833101995723194437> ENABLED" : "<a:nope:989296885820964874> DISABLED"}`)
        ...
        var embed11 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "📈 Ranking").size}\`] 📈 Ranking Commands 📈 | ${settings.RANKING ? "<a:yes:833101995723194437> ENABLED" : "<a:nope:989296885820964874> DISABLED"}`)
        ...
        var embed12 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🔊 Soundboard").size}\`] 🔊 Soundboard Commands 🔊 | ${settings.SOUNDBOARD ? "<a:yes:833101995723194437> ENABLED" : "<a:nope:989296885820964874> DISABLED"}`)
        ...
        var embed13 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🎤 Voice").first().extracustomdesc.length}\`] 🎤 Voice Commands 🎤 | ${settings.VOICE ? "<a:yes:833101995723194437> ENABLED" : "<a:nope:989296885820964874> DISABLED"}`)
        ...
        var embed14 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🕹️ Fun").size}\`] 🕹️ Fun Commands 🕹️ | ${settings.FUN ? "<a:yes:833101995723194437> ENABLED" : "<a:nope:989296885820964874> DISABLED"}`)
        ...
        var embed15 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🎮 MiniGames").size}\`] 🎮 Mini Games Commands 🎮 | ${settings.MINIGAMES ? "<a:yes:833101995723194437> ENABLED" : "<a:nope:989296885820964874> DISABLED"}`)
          .addField("\u200b", "__**Sub-Categorized Commands:**__")
        ...
        var embed16 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "😳 Anime-Emotions").size}\`] 😳 Anime Commands 😳 | ${settings.ANIME ? "<a:yes:833101995723194437> ENABLED" : "<a:nope:989296885820964874> DISABLED"}`)
        ...
        var embed17 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🔞 NSFW").size}\`] 🔞 NSFW Commands 🔞 | ${settings.NSFW ? "<a:yes:833101995723194437> ENABLED" : "<a:nope:989296885820964874> DISABLED"}`)
