...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      let button_public_invite = new MessageButton().setStyle('LINK').setLabel('Dashboard').setURL("https://comingsoon.com")
      let button_support_dc = new MessageButton().setStyle('LINK').setLabel('Support Server').setURL("https://discord.gg/ymnQXzyBw8")
      ...
      message.reply({
        embeds: [new MessageEmbed()
          ...
          .setFooter('0x5EC06745 Bot | powered by dark-web.ro', 'https://imgur.com/jPItIw0.gif')
          .setURL("https://discord.gg/ymnQXzyBw8")],
