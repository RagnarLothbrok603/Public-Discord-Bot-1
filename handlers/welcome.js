  ...
  client.on("guildMemberAdd", async mem => {
    ...
    async function welcome(member) {
      ...
      if (invite && inviter) {
        ...
        invitemessage = `Invited by ${inviter.tag ? `**${inviter.tag}**` : `<@${inviter.id}>`}\n<:like:990274232913117205> **${realinvites} Invite${realinvites == 1 ? "" : "s"}**\n[<a:joinvc:989294624591982593> ${invites} Joins | <a:leave:989295670433308692> ${leaves} Leaves | <a:nope:989296885820964874> ${fake} Fakes]`;
      } 
      else if(invite){
