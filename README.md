...
<a href="https://discord.gg/dcdev"><img src="https://ptb.discord.com/api/guilds/932702225501929572/widget.json"></a>
 
[**Invite the Public Version of this Bot**](https://discord.com/api/oauth2/authorize?client_id=882149559197921362&permissions=8&scope=bot) so you don't need to host it by yourself or [join my Discord server](https://discord.gg/h9tPGZxcQk) to get a custom Bot hosted for you!


# Important notes and thank ❤️
First of all, thanks for using this Source Code, it was and is a ton of work to create and maintain it!
That's why I'm asking everyone to [**donate a little bit of money**](https://discord.gg/h9tPGZxcQk) or if that's not possible, then join my [Discord Server](https://discord.gg/h9tPGZxcQk)!
...
<details>
  ...
  * A VPS would be advised, so you don't need to keep your PC/laptop/RasPi 24/7 online! [Click here for a debian setup](comingsoon).
  * Check out my recommended Host: [BERO-HOST](https://bero.milrato.dev) and use code `RagnarLothbrok` for cheap OP VPS (kvm)
...
<details>
  ...
  1. Download the [Source Code](https://github.com/RagnarLothbrok603/discord-bot-main)
     * Either by: `git clone https://github.com/RagnarLothbrok603/discord-bot-main`
...
<details>
  ...
  *There are many public ones out there for example lava.link*
  ...
  1. Make sure `Java 11` is installed on your system!
     * [Click here for a Download for **Linux**](da)
     * [Click here for a Download for **Windows**](https://downloads.0x5EC06745#4435/windows/java/jdk-11.0.11.exe) ​
...
<details>
  ...
  **NOTE:** *You can do the exact same configuration inside of the `example.env` file, just make sure to rename it to `.env` or use environment variables!*
   ...
   5. Now start the bot by opening a cmd line in that folder and typing: `node index.js` or `npm start`
     * If you don't want to keep the terminal open or if you're on linux, check out [pm2 (and my tutorial)](https://github.com/RagnarLothbrok603/discord-bot-main) and type: `pm2 start --name Bot_Name index.js`
...
## SUPPORT ME AND Ragnar Lothbrok
...
> Example: `Bot Coded by [0x5EC06745#4435](https://discord.gg/dcdev) but modified by [modifier/your Name](https://discord.gg/)`
...
> Please consider, that [**0x5EC06745#4435**](https://github.com/RagnarLothbrok603/) is the main Developer of this Bot, everyone else helped just once or sometimes more often.
